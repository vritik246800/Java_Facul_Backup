...
9. Cálculo de fatorial (iterativo / recursivo)  
...
21. Sistema de gerenciamento de biblioteca  
...
26. Sistema de gerenciamento de estoque / inventário  
27. Sistema de vendas / ponto de venda (POS)  
28. Sistema de emissão de bilhetes de evento  
29. Aplicativo de chat local (usando sockets)  
30. Aplicativo de chat cliente-servidor via rede  
31. Jogo de xadrez ou damas  
32. Jogo de Sudoku  
...
37. Gerador de relatórios (PDF, CSV)  
38. Sistema de blog (posts, comentários)  
39. Aplicativo de upload / download de arquivos  
40. Sistema de votações / enquetes  

## 🔷 Projetos com banco de dados / CRUD mais estruturado

41. Sistema de cadastro / login de usuários  
42. Sistema de biblioteca com base de dados  
...
48. Carrinho de compras + checkout  
...
76. Dashboard / gráficos interativos  
